<template>
    ...
    <div class="main">
			<div class="regLoginBox">
				<div class="logo">
					<div class="img"><img src="/static/images/shop5.png"></div>
				</div>
				<div class="from pd10">
					<div class="from-line">
					...
					<div class="from-line">
						...
						<button class="getcode" style="background:#ff5c29;font-size:28rpx;" @click="getVerifyCode(this)">{{btnText}}</button>
					</div>
					<div class="from-line">
            ...
            <input type="checkbox" checked class="checkbox-cart"/>
						<text style="font-size:28rpx">我已阅读并同意</text><text style="color:#ff5c29;font-size:28rpx">《用户协议》</text>
					</div>
				</div>
...
export default {
  ...
  methods: {
	...
	async	Register(){
      ...
      console.log("666")
			if(this.phoneNumber==""||this.verifyCode==""||this.password==""||this.password2=="")
			{
			 wx.showToast({
       title: '字段不能为空',
       icon: 'none',
        ...
        success:(res)=>{
          ...
          if(res.data.code==0){
              ...
              wx.showToast({
                  ...
                  icon: 'success',
					        duration: 2000,
					        complete: function () {//绑定手机成功之后,延时2秒跳转到会员中心
                    setTimeout(function() {
                    wx.switchTab({
                    url:"/pages/mine/main",
                    })
              ...
              wx.showToast({
              title: result.data.message, //提示的内容,
              icon: "none", //图标,
              duration: 1500, //延迟时间,
   ...
   sendbindcode(phoneNum){
    ...
    var result = post("Login/GetUserSms",{
          Mobile:this.phoneNumber,
          VerifyType:"0",
          });
		 console.log(result);
